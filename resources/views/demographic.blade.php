        ...
        <div class="container">
            ...
            <hr size="4px;">
				...
				<div class="row">
					...
					<select class="form-select form-select-sm" aria-label="Default select example" id="device_brand" name="device_brand" required onchange="loadDeviceModels(this)">
						<option value="">Select</option>
					</select>
					<br>
					</div>
				...
				<div class="row">
					...
					<select class="form-select form-select-sm" aria-label="Default select example" id="device_model" name="device_model" required onchange="enableButton()">
						<option value="">Select</option>
					</select>
					<br>
				</div>
...
function loadDeviceModels(selectObject)
{
	...
	var model_select = document.getElementById('device_model')
	if (value != '')
	{
		var models = Array.from(lines.get(value));
		removeOptions(model_select);
		device_model.innerHTML += `<option value="Select">Select</option>`;
		models.forEach(op => device_model.innerHTML += `<option value="${op}">${op}</option>`);
	}
	else
	{
		removeOptions(model_select);
...
function enableButton()
{
    ...
    var selectbrand = document.getElementById('device_brand');
    var selectmodel = document.getElementById('device_model');
...
function processData(allText) {
  ...
  brands.forEach(op => device_brand.innerHTML += `<option value="${op}">${op}</option>`);
};
